...
def main():
	...
	parser.add_argument('--ubuntu',help="ubuntu version: 14.04 16.04",default="16.04",choices=["16.04","14.04"])
	parser.add_argument('--cuda',help="cuda version: 7.5,8.0,9.0,9.1 - not all combinations (ubuntu,cuda,cudnn) are possible",default="",choices=["9.1","9.0","8.0","7.5","7.0"])
	...
	parser.add_argument('--sse4',help="enable sse4",action="store_true")
	parser.add_argument('--avx2',help="enable avx2",action="store_true")
	parser.add_argument('--runtime',help="runtime only",action="store_true")
	parser.add_argument('--pytorch',help="enable pytorch",action="store_true")
	parser.add_argument('--dlib',help="enable dlib",action="store_true")
	parser.add_argument('--tensorflow',type=bool,help="installs 1.6")
	parser.add_argument('--cudnn',help="(ubuntu,cuda,cudnn) not all combinations possible",default="",choices=["3","4","5","6","7"])
	parser.add_argument('--python',help="python version",default="2.7")

	#parser.add_argument('--gcc',help="enable gcc update")
	parser.add_argument('--boost',help="enable boost update with this version",action="store_true")
	parser.add_argument('--ffmpeg',help="enable ffmpeg",action="store_true")
	parser.add_argument('--gstreamer',help="enable gstreamer",action="store_true")
